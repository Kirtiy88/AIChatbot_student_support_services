...
def get_ai_reply(message, lang="en"):
    ...
    try:
        language_instruction = (
            "The student wrote in Hindi/Hinglish, so you MUST reply only in Hindi (Hinglish, Roman script). Do not reply in English."
            if lang == "hi" else
            "The student wrote in English, so you MUST reply only in English. Do not reply in Hindi."
        )
